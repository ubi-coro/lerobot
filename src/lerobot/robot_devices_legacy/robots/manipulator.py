"""LEGACY: imported from old GUI branch; scheduled for removal."""
...
from lerobot.robot_devices_legacy.cameras.utils import Camera, make_cameras_from_configs
from lerobot.robot_devices_legacy.motors.utils import MotorsBus, make_motors_buses_from_configs
from lerobot.robot_devices_legacy.utils import RobotDeviceNotConnectedError, RobotDeviceAlreadyConnectedError
from lerobot.robot_devices_legacy.robots.utils import get_arm_id
from lerobot.robot_devices_legacy.robots.configs import ManipulatorRobotConfig
from lerobot.common.utils.utils import init_logging

 # legacy dynamixel error handler removed
...
class ManipulatorRobot:
    ...
    def __init__(
        ...
        self.logs = {}
        self.error_monitor = None  # legacy error monitoring removed
    ...
    def connect(self):
        ...
        if self.robot_type in ["koch", "koch_bimanual", "aloha"]:
            from lerobot.robot_devices_legacy.motors.dynamixel import TorqueMode
        elif self.robot_type in ["so100", "so101", "moss", "lekiwi"]:
            from lerobot.robot_devices_legacy.motors.feetech import TorqueMode
    ...
    def activate_calibration(self):
        ...
        def load_or_run_calibration_(name, arm, arm_type):
            ...
            if arm_calib_path.exists():
                ...
                if self.robot_type in ["koch", "koch_bimanual", "aloha"]:
                    from lerobot.robot_devices_legacy.robots.dynamixel_calibration import run_arm_calibration
                    from lerobot.robot_devices_legacy.motors.dynamixel import TorqueMode
                    ...
                    from lerobot.robot_devices_legacy.robots.feetech_calibration import run_arm_manual_calibration
                    from lerobot.robot_devices_legacy.motors.feetech import TorqueMode
